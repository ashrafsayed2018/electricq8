...
<section class="eq8-stats-section">
    <div class="eq8-pg-inner">
        ...
        <div class="eq8-stats">
            <div class="eq8-stats__item"><span class="eq8-stats__num">+10</span><span class="eq8-stats__label">{{ $isAr ? 'سنوات خبرة' : 'Years Experience' }}</span></div>
            <div class="eq8-stats__item"><span class="eq8-stats__num">+5000</span><span class="eq8-stats__label">{{ $isAr ? 'عميل راضٍ' : 'Satisfied Customers' }}</span></div>
            <div class="eq8-stats__item"><span class="eq8-stats__num">+15000</span><span class="eq8-stats__label">{{ $isAr ? 'مشروع منجز' : 'Projects Done' }}</span></div>
            <div class="eq8-stats__item"><span class="eq8-stats__num">6</span><span class="eq8-stats__label">{{ $isAr ? 'محافظات مغطاة' : 'Governorates Covered' }}</span></div>
        </div>
    </div>
</section>
    ...
    <div class="eq8-pg-inner">
        ...
        <div class="eq8-pg-grid-3">
            ...
            <div class="eq8-mini-card">
                <span class="eq8-mini-card__icon">{{ $icon }}</span>
    ...
    <div class="eq8-pg-inner">
        ...
        <div class="eq8-pg-grid-2">
            ...
            <div class="eq8-reason-card">
                <span class="eq8-reason-card__icon">{{ $icon }}</span>
                <div>
...
{{-- Contact info --}}
<section class="eq8-pg-section" style="background:var(--altBg)">
    <div class="eq8-pg-inner" style="max-width:800px">
        <div class="eq8-section-head">
        ...
        <div style="text-align:center;margin-top:32px">
            <p class="eq8-section-sub" style="margin-bottom:16px">{{ $isAr ? 'تابعنا على منصات التواصل' : 'Follow us on social media' }}</p>
...
<section class="eq8-cta-section">
    <div class="eq8-pg-inner" style="text-align:center;max-width:700px">
        <h2 class="eq8-section-title" style="color:#fff;margin-bottom:12px">{{ $isAr ? 'مستعد لخدمتك الآن' : 'Ready to Serve You Now' }}</h2>
        <p style="color:#F3D9BB;margin-bottom:32px;font-size:1.05rem">{{ $isAr ? 'تواصل مع فريق إلكتريك كويت — فنيونا جاهزون في جميع مناطق الكويت' : 'Contact the ElectricQ8 team — our technicians are ready across all Kuwait areas' }}</p>
...
/* ── Stats band ──────────────────────────────────────────────── */
.eq8-stats-section { background:linear-gradient(135deg,#43230E 0%,#6B3A17 100%); padding:64px 20px; }

/* ── Mini card ───────────────────────────────────────────────── */
.eq8-mini-card { background:var(--cardBg); border:1px solid var(--border); border-radius:14px; padding:22px; transition:border-color .2s,box-shadow .2s; }
.eq8-mini-card:hover { border-color:var(--accent); box-shadow:0 4px 16px rgba(107,58,23,.1); }
.eq8-mini-card__icon { font-size:1.8rem; display:block; margin-bottom:10px; }
.eq8-mini-card__title { font-size:.9rem; font-weight:700; color:var(--text); margin:0 0 6px; font-family:'Cairo',system-ui,sans-serif; }
.eq8-mini-card__body { font-size:.8rem; color:var(--body); line-height:1.65; margin:0; font-family:'Cairo',system-ui,sans-serif; }
...
/* ── Reason card ─────────────────────────────────────────────── */
.eq8-reason-card { display:flex; gap:14px; align-items:flex-start; background:var(--cardBg); border:1px solid var(--border); border-radius:14px; padding:20px; transition:border-color .2s; }
.eq8-reason-card:hover { border-color:var(--accent); }
.eq8-reason-card__icon { font-size:1.4rem; flex-shrink:0; margin-top:2px; }
...
/* ── CTA section ─────────────────────────────────────────────── */
.eq8-cta-section { background:linear-gradient(135deg,#43230E 0%,#6B3A17 100%); padding:64px 20px; text-align:center; }
</style>
@endsection
